<x-guest-layout>
    ...
    <section class="flex w-2/4 flex-wrap justify-center items-center mx-auto rounded-lg p-2 bg-gray-100" style="width:380px;">
        <h4 class="w-full text-3xl text-center py-4 text-gray-950 border-b-2">Cadastrar no Sistema</h4>
        <form method="POST" action="{{ route('register') }}" class="w-full">
            @csrf
            <input type="hidden" name="_token" value="{{ csrf_token() }}" />

            <div class="mb-2">
                <label for="name" class="block mb-1 font-medium text-gray-950 dark:text-white text-lg">Nome:</label>
            ...
            <div class="mb-2">
                <label for="password" class="block mb-1 font-medium text-gray-950 dark:text-white text-lg">Senha:</label>
            ...
            <div class="mb-2">
                <label for="password" class="block mb-1 font-medium text-gray-950 dark:text-white text-lg">Confirmar Senha:</label>
            ...
            <button type="submit" class="focus:outline-none font-medium mt-2 text-lg w-full px-5 py-2.5 text-center bg-blue-500 focus:border-transparent focus:ring-0 focus:outline-none rounded-lg text-white">Cadastrar</button>
